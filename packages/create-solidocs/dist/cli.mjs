...
/** Files written for every new site. Values are interpolated. */
const templates = (o) => [
  [
    "package.json",
    JSON.stringify(
  ...
  ["tsconfig.json", JSON.stringify({ compilerOptions: { noEmit: true } }, null, 2) + "\n"],
  [
    "solidocs.config.ts",
...
Options:
  ...
  const title =
    typeof values.title === "string" && values.title ? values.title : path.basename(target)
